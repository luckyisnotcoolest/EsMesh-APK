/*
 * ==============================================================================
 *  EsMesh Node Firmware - ESP32-C3 Target (Arduino IDE Sketch)
 * ==============================================================================
 *  Board: ESP32C3 Dev Module / ESP32-C3-DevKitM-1 / Seeed Xiao ESP32C3
 *  Settings:
...
void setup() {
    ...
    Serial.println("  Target: ESP32-C3 (RISC-V Architecture)");
    Serial.println("==========================================\n");
    ...
    Serial.printf("[EsMesh-C3] Node ID: 0x%08X ready.\n", mesh.getNodeId());
}
...
void loadConfiguration() {
    ...
    config.nodeName = preferences.getString("name", "ESM-C3");
